class LayoutGenerator < Rails::Generators::Base
  ...
  def layout_files
    ...
    template "_meta_social_analytics.html.erb", "app/views/layouts/_meta_social_analytics.html.erb"
  ...
  def add_image
    copy_file "background-nadvence.jpg", "app/assets/images/background-nadvence.jpg"
  end
