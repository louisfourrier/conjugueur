...
class VerbsControllerTest < ActionController::TestCase
  ...
  test "should create verb" do
    assert_difference('Verb.count') do
      post :create, verb: { auxiliary: @verb.auxiliary, content: @verb.content, definition: @verb.definition, employ: @verb.employ, group: @verb.group }
    end
  ...
  test "should update verb" do
    patch :update, id: @verb, verb: { auxiliary: @verb.auxiliary, content: @verb.content, definition: @verb.definition, employ: @verb.employ, group: @verb.group }
    assert_redirected_to verb_path(assigns(:verb))
  end
